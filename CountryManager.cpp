...
void CountryManager::addCity(QString countryName, QString cityName, int cityIp)
{
    // Country *country = m_countryList.value(countryName, nullptr);

    // if (country != nullptr)
    // {
    //     country->addCity(cityName, cityIp);
    // }
}
